...
[ -z "$DESIGN" ] && DESIGN=$(ls -t openspec/changes/*/design.md 2>/dev/null | head -1)
...
- `.opencode/skills/gstack-plan-design-review/SKILL.md` (only if UI scope detected)
- `.opencode/skills/gstack-plan-eng-review/SKILL.md`
- `.opencode/skills/gstack-plan-devex-review/SKILL.md` (only if DX scope detected)
